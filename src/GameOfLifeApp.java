...
public class GameOfLifeApp extends JFrame {
	...
	public GameOfLifeApp(String title, int numbrows, int numbcols, int squaresize) {
		...
		panel = new GameOfLifeUI(numbrows, numbcols, squaresize, game);
		add(panel, BorderLayout.CENTER);

		game = new GameOfLife(numbrows, numbcols, panel);
	...
	public static void main(String[] args) {
		...
		try {
			...
			//e.printStackTrace();
			System.err.println("");
			System.out.println("USAGE: java gameOfLife.gameOfLife.GameOfLifeApp [-parameter value]");
			System.err.println("");
